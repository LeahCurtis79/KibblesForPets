...
function saveData() {
	...
	setCookie('interestMusic', document.getElementById('interestMusic').checked, 30);
	setCookie('interestSports', document.getElementById('interestSports').checked, 30);
	setCookie('interestComputers', document.getElementById('interestComputers').checked, 30);
