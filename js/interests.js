...
function saveData() {
	...
	setCookie('interestPitbull', document.getElementById('interestPitbull').checked, 30);
	setCookie('interestLabs', document.getElementById('interestLabs').checked, 30);
	setCookie('interestMastiff', document.getElementById('interestMastiff').checked, 30);
